...
```
##            mean        sd      5.5%      94.5%
## mu    154.60692 0.4120014 153.94846 155.265375
## sigma   7.73146 0.2913980   7.26575   8.197171
```
...
## sigma  24.51755 0.9289222  23.03295  26.00215
```
...
```
##                 mu        sigma
## mu    0.1697259810 0.0002085292
## sigma 0.0002085292 0.0848888234
```
...
```
##               mu      sigma
## mu    1.00000000 0.00173727
## sigma 0.00173727 1.00000000
```
...
```
##             mean        sd       5.5%      94.5%    histogram
## mu    154.608742 0.4113953 153.948653 155.265957      ▁▁▅▇▂▁▁
## sigma   7.727185 0.2923870   7.260294   8.196622 ▁▁▁▂▅▇▇▃▁▁▁▁
```
...
m.4M2 <- quap(list.4M2 , data=data.frame(yi=prior_y),start=list(mu=0,sigma=5))
```
