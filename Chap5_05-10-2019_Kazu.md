...
## bA    1.1331112 0.0718872 1.0182216 1.2480009
...
## bG    0.7696980 0.05536648 0.6812116 0.8581843
...
```
##             mean        sd       5.5%      94.5%
## a      0.6419053 0.1987815  0.3242140 0.95959658
## bG    -0.1982574 0.1481970 -0.4351049 0.03859007
## bA     1.3936635 0.2084483  1.0605228 1.72680420
## sigma  1.5486784 0.1093461  1.3739222 1.72343454
```
...
mu <- link( practice.5H2 , data=list(groupsize=xseq2) ) # how to use?
```

```
## Error in eval(parse(text = lm), envir = e): object 'area' not found
```
