...
SW.sim <- rnorm(N,mean=0.3*HL.sim) # SW, seed weight (g)
PL.sim<-rnorm(N,PL.sim-3*SW.sim)  #sim HL.sim -> PL.sim (positive), SW.sim -> PL.sim (negative)
