...
```
##        mean        sd      5.5%     94.5%
## p 0.6666672 0.1571337 0.4155372 0.9177971
```
...
![](Chap2_04-12-2019_Kazu_files/figure-html/unnamed-chunk-4-1.png)<!-- -->
# (2) W,W,W,L
...
![](Chap2_04-12-2019_Kazu_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
![](Chap2_04-12-2019_Kazu_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
```r
table<-data.frame(case=1:6,card=rep(1:3, each=2),heads=c("B1","B2","B","W","W1","W2"),tails=c("B2","B1","W","B","W2","W1"))
table
```

```
##   case card heads tails
## 1    1    1    B1    B2
## 2    2    1    B2    B1
## 3    3    2     B     W
## 4    4    2     W     B
...
```r
table2<-data.frame(case=1:2^3,card=rep(1:4, each=2),heads=c("B1","B2","B","W","W1","W2","B1","B2"),tails=c("B2","B1","W","B","W2","W1","B2","B1"))
table2
```
